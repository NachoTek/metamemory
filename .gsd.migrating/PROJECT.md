...
**Key Innovation:** Always-on widget that captures audio silently with real-time transcription and confidence-coded output — designed to disappear into the desktop while providing reliable conversation capture for downstream AI agent processing.
...
| FakeAudioModule testing | Reproducible benchmarking without real meetings | — Pending |
| Confidence color coding | Users can see transcription quality at a glance via color coding | — Pending |
