...
plan: 08
subsystem: audio
tags: [audio, crash-recovery, storage, wav]

requires:
  - "01-01 through 01-04 core audio implementation"
provides:
  - "Clean recordings directory after normal shutdown"
  - "No false positive recovery prompts"
affects: []

tech-stack.added: []
tech-stack.removed: []
tech-stack.patterns:
  - "Default cleanup after finalization"
...
decisions:
  - id: "default-delete-true"
    decision: "finalize_stem() defaults to delete_part=True"
    rationale: "Safer default - cleanup is the normal case, preservation is for debugging"
    consequences: "All existing callers now clean up by default; set False to preserve files"
